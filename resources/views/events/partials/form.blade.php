...
<form action="{{ ($event->exists) ? route('events.update', ['id' => $event->id]) : route('events.store') }}" method="post" id="events--add-edit-form">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            <input type="text" name="event[title]" class="form-control" placeholder="My Soccer Game" value="{{ $event->title }}"_required>
        </div>
    </div>
    <div class="form-group row">
        <label class="col-sm-2 col-form-label">Sport</label>
        <div class="col-sm-10">
            <select name="event[type_id]" class="form-control" _required>
                <option value=""></option>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-10">
            ...
            <input type="text" name="venue[name]" class="form-control js-typeahead-venue" value="{{ ($event->exists) ? $event->venue->name : '' }}"
                _required
